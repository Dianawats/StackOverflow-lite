class Questions:
    ...
    def list_of_question(self):
        ...
        self.questions = [
            {
                'id': 1,
                'question_body': 'how to write a method using hibernate which returns boolean',
                'question_tags': 'javascript', 
                'answer': [
                    {
                        'answer_id': 1,
                        'answer_body': 'for that debug and check what your query exactly returns if true then here also will return true only',
